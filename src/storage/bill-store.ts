 ...
 * schema. When a second one exists, this is where the upgrade goes.
 */
export function loadBills(storage: Storage | null = defaultStorage()): LoadResult {
  ...
  // Data written by a future version cannot be read backwards. Starting empty
  // beats rendering a bill whose meaning has changed underneath.
